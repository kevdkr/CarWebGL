import {lookAt, mat4, perspective, toradians, vec4} from "./helperfunctions.js";
...
export class Camera {
    ...
    setFreeCameraF(xoffset:number, zoffset:number) {
    ...
    setViewpointCamera(xoffset:number, zoffset:number, frontRotation:number, driverHeadRotation:number) {
    ...
    setChaseCamera(xoffset:number, zoffset:number, frontRotation:number) {
